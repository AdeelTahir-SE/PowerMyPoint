    ...
    return (
        <>
            ...
            <button
                ...
                className={`lg:hidden fixed top-4 left-4 z-50 p-2 bg-slate-900 border border-white/10 rounded-lg text-white ${isOpen ? 'hidden' : 'block'}`}
            >
                <Menu size={24} />
            </button>
            ...
            {/* Sidebar */}
            <aside className={`
                fixed inset-y-0 left-0 z-40 bg-slate-900/95 backdrop-blur-xl border-r border-white/10 
                transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:flex lg:flex-col lg:h-screen lg:w-64 overflow-hidden border-2
