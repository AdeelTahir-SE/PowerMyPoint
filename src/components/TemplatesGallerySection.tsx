  ...
  return (
    <section className="w-full bg-slate-50 dark:bg-black py-20 px-4">
      <div className="max-w-5xl mx-auto px-8">
        <h2 className="text-5xl md:text-7xl font-bold text-center mb-10 text-gray-900 dark:text-white">
          Made with PowerMyPoint
        </h2>
        <p className="text-center text-xl md:text-2xl text-slate-500 mb-12 max-w-2xl mx-auto">
          See what's possible. All these presentations were generated in seconds using our AI.
        </p>
        <HoverEffect items={examples} />
      </div>
    </section>
  );
};
...
const examples = [
  {
    ...
    description: 'Generated from: "Create a Q4 strategy deck with a focus on growth and retention."',
    link: '#',
  ...
  },
  {
    ...
    description: 'Generated from: "Launch deck for a new eco-friendly coffee maker."',
    link: '#',
  ...
  },
  {
    ...
    description: 'Generated from: "Keynote regarding the future of web development."',
    link: '#',
  ...
  {
    title: 'Team Meeting',
    description: 'Generated from: "Weekly engineering standup agenda and metrics."',
    link: '#',
  ...
  },
  {
    ...
    description: 'Generated from: "Introduction to Quantum Physics for high school students."',
    link: '#',
    image: 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?q=80&w=2574&auto=format&fit=crop',
  },
  {
    title: 'Portfolio Showcase',
    description: 'Generated from: "Minimalist design portfolio with black and white theme."',
    link: '#',
