                        ...
                        <div className="relative bg-slate-900/90 backdrop-blur-xl rounded-3xl p-8 md:p-10 border border-white/10 shadow-2xl">
                            ...
                            <div className="mt-8 text-center">
                                <p className="text-slate-400">
                                    ...
                                    <Link href="/signup" className="text-purple-400 hover:text-purple-300 font-bold transition-colors underline decoration-blue-400/50 hover:decoration-blue-300">
                                        Create Account
                                    </Link>
                                </p>
                            </div>
